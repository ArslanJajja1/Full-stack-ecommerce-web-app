...
const REACT_APP_FORGOT_PASSWORD_REDIRECT=process.env.REACT_APP_FORGOT_PASSWORD_REDIRECT
...
const ForgotPassword = () => {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: '#2c2c6c', marginTop: '3.2rem', minWidth: 'max-content', maxWidth: '50%' }}
    >
      <h4
